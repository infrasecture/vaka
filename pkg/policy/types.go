...
type ServicePolicy struct {
	...
	RequiredRuntimeVersion string                    `yaml:"requiredRuntimeVersion,omitempty"`
...
type ServiceConfig struct {
	...
	// User is the effective service identity in docker-compose syntax
	// (e.g. "app", "1000", "1000:1000", "app:app"). This field is
	// generated by vaka for injected per-service policies and is rejected
	// in user-authored host vaka.yaml.
	User string `yaml:"user,omitempty"`
	// GroupAdd preserves Compose's configured supplementary groups across the
	// privileged Vaka trampoline. It is generated alongside User and is not a
	// host policy setting.
