...
--vaka-pull=<missing-pinned|missing|never|always> controls whether a missing
service image is fetched when vaka must inspect it (default missing-pinned:
only digest-pinned images are pulled).`,
		SilenceUsage:          true,
